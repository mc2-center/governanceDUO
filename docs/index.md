...
| [Use cases and data sources](use-cases.md) | What each part of this model is for, where its data is meant to come from (the goal: Synapse's API, 100% of the time), and what's actually operational vs. design-only today |
