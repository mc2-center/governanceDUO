...
crosswalk. The root [`README.md`](../README.md) covers the schematic CSV pipeline,
...
and then `gen-doc` itself, rewriting `docs/reference/`. The four narrative pages in
...
root. `docs/.pages` pins the four narrative pages in reading order and folds in
