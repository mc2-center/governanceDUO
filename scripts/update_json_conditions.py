...
usage: update_json_conditions.py [-h] [-ar AR_SCHEMA] input_path

Generate corrected JSON schema

positional arguments:
  input_path            Path to a JSON schema file.

options:
  -h, --help            show this help message and exit
  -ar AR_SCHEMA, --ar_schema AR_SCHEMA
                        URI for registered AR JSON schema
...
if __name__ == "__main__":
    ...
    parser.add_argument("-ar", "--ar_schema", help="URI for registered AR JSON schema", required=False)
